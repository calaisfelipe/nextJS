...
const AsideBar = ({meta}:{meta:string}) => {
  ...
  return (
    <div className="flex-col w-44 bg-cyan-700 dark:bg-blue-900 hidden sm:flex">
      <div>
        <Image
          src={ProfilePhoto}
          height={118}
        ...
        <p className="tracking-tighter text-xs w-full text-center font-semibold opacity-40 text-white ">Web Developer / Front-End</p>
      </div>
