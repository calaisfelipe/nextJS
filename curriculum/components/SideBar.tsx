...
const SideBar = ({meta}:{meta:string}) => {
  return (
    <>
    <div className='sm:block bg-yellow-500 dark:bg-blue-900  absolute sm:top-[25%] sm:left-[95%] sm:bottom-auto sm:w-fit w-full flex justify-center bottom-[-4.3%] z-50 sm:rounded-full py-2 '>
